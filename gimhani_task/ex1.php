...
<body>
   ...
   <?php
   // use backshash to special character like
   echo"Hello world! My name is \"David\"";
   ?>
   <h4>3.2 Create a PHP variable named $title and assign it the value "PHP is interesting." Then, use this variable as the content within an <h4> (heading 4) element.</h4>
   ...
   ?>
   <table><tr><th>S.n.</th><th>Name</th><th>Grade</th>
   <tr>
    <td>1</td>
    <td>John</td>
    <td><?php echo $g1 ?></td>
